    ...
    <div class="col-md-<?php if($options["photo"] == true) { echo "8"; } else { echo "12"; } ?>">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input id="MESA_RESERVA_ID" type="text" class="form-control" placeholder="RESERVA_ID" aria-describedby="basic-addon">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <textarea id="COMENTARIOS" class="form-control" placeholder="COMENTARIOS" aria-describedby="basic-addon"></textarea>
            </div>
