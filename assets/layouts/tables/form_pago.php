...
<div id="<?php echo $table_name; ?>" class="panel panel-default">
    ...
    <div class="col-md-<?php if($options["photo"] == true) { echo "8"; } else { echo "12"; } ?>">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input id="MESA_RESERVA_ID" type="text" class="form-control" placeholder="MESA_RESERVA_ID" aria-describedby="basic-addon">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input id="MONTO" type="text" class="form-control" placeholder="MONTO" aria-describedby="basic-addon">
            </div>
    ...
    <div class="panel-footer">
        ...
        <button id="new" type="button" class="new btn btn-success btn-md">
            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo Pago
        </button>

        <button id="update" type="button" class="update btn btn-info btn-md" disabled>
            <span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Actualizar Pago
        </button>

        <button id="delete" type="button" class="delete btn btn-danger btn-md" disabled>
            <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Eliminar Pago
        </button>
