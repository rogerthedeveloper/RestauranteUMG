...
<div id="<?php echo $table_name; ?>" class="panel panel-default">
    ...
    <div class="col-md-<?php if($options["photo"] == true) { echo "8"; } else { echo "12"; } ?>">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input id="INGREDIENTE_ID" type="text" class="form-control" placeholder="INGREDIENTE_ID" aria-describedby="basic-addon">
            </div>
        ...
        <div class="form-group">
            ...
            <button id="create" type="button" class="create btn btn-primary btn-md btn-lg center-block">
                <span class="glyphicon glyphicon-save" aria-hidden="true"></span> Agregar Producto
            </button>
    ...
    <div class="panel-footer">
        ...
        <button id="update" type="button" class="update btn btn-info btn-md" disabled>
            <span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Actualizar Producto
        </button>

        <button id="delete" type="button" class="delete btn btn-danger btn-md" disabled>
            <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Eliminar Producto
        </button>
